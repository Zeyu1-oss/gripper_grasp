...
def main():
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        while viewer.is_running():
            ...
            if phase == "align_xy":
                ...
                print(data.geom_xmat[gid_target].reshape(3, 3))
    ...
    # 让"指尖底部"停在目标底面上方 DOWN_SAFE_GAP
                ...
                if err <= 0.001: 
                    ...
                    print(f"[DESCEND] 下降中，误差: {err:.4f}, 步长: {step:.4f}")
    ...
    # 保留原有的接触检测作为安全备份
            ...
            #     data.ctrl[aid_lift] = lift_cmd+0.186
            #     wait_steps(model, data, 2)
