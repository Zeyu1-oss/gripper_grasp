...
def main():
    ...
    # 读取当前接触与力
                ...
                print("Actuator left:", model.actuator_ctrlrange[aid_left])
                print("Actuator right:", model.actuator_ctrlrange[aid_right])
   
                data.ctrl[aid_right]=-0.8
                data.ctrl[aid_left]=-0.8
                loZ, hiZ = model.actuator_ctrlrange[aid_lift]
