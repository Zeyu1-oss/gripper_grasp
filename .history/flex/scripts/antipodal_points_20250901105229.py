...
class AntipodalGraspGenerator:
    def __init__(self, mu=0.4, opp_angle_deg=30.0, m_dirs=8, seed=42,
        ...
        self.m_dirs = m_dirs          # 摩擦锥离散方向数（可调 8/16）
    ...
    def generate_for_mesh(self, mesh_path, scale=0.01,
        ...
        # 侧面优先采样（替换原先的均匀采样）
        points, normals = self._side_biased_surface_samples(mesh, num_samples)
...
# ========== CLI ==========
def main():
    ap = argparse.ArgumentParser("Antipodal grasp generator (侧面优先 + 摩擦锥 ε)")
