...
class AntipodalGraspGenerator:
    ...
    def generate_for_mesh(self, mesh_path, scale=0.01,
        ...
        meta = {"__meta__": True, "T_mesh_4x4": T_mesh,
                "scale": scale, "rot_deg": rot, "rot_order": rot_order}
...
# ========== main ==========
def main():
    ap = argparse.ArgumentParser("Batch antipodal grasp generator (uniform surface sampling)")
    ...
    ap.add_argument("--rot", type=float, nargs=3, default=(90, 0, 0))
