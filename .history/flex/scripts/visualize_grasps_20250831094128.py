...
def main():
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        ...
        for _ in range(close_steps):
            ...
            data.qvel[:] = 0.0
            mujoco.mj_forward(model, data)   # SDF 需要 forward+step 才会出稳定接触
        ...
        print("阶段 4：开启重力（手被焊接不动，SDF 碰撞），观察 LEGO …")
