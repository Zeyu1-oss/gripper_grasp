...
def main():
    ...
    # 采样/过滤/打分
    ap.add_argument("--num_samples", type=int, default=300000)
    ap.add_argument("--max_keep", type=int, default=80000)
    ap.add_argument("--topk", type=int, default=40000)
    ap.add_argument("--mu", type=float, default=0.4)
    ap.add_argument("--opp_angle_deg", type=float, default=30.0, help="可选：保留反法向粗过滤")
    ...
    # 线穿质心
    ap.add_argument("--require_through_com", action="store_true", default=False)
    ap.add_argument("--no_require_through_com", dest="require_through_com", action="store_false")
    ap.add_argument("--through_tol_ratio", type=float, default=0.5)
