...
#                  m_dirs=8,
#                  seed=42,
#                  require_through_com=False,  # ✅ 改成可选
#                  through_tol_ratio=0.3,
...
#         print(f"几何过滤后候选数: {len(candidates)}")
...
#                           "center":0.5*(r.p1+r.p2)})

#         if out_path:
#             os.makedirs(os.path.dirname(out_path), exist_ok=True)
#             np.save(out_path, np.array(pairs,dtype=object), allow_pickle=True)
...
# # ========== main ==========
# def main():
#     ap = argparse.ArgumentParser("Antipodal grasp generator (均匀覆盖)")
...
def main():
    ...
    ap.add_argument("--scale", type=float, default=0.01)
    ap.add_argument("--out_dir", type=str, default="../results/legos_pairs")
