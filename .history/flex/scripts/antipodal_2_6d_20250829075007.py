...
def pair_to_grasp_pose(p1, p2, palm_offset=0.0675):
    """
    最稳定可靠的夹爪6D位姿计算方法
    使用世界坐标系z轴作为夹爪z轴方向
    """
...
def pairs_to_grasp_poses(pairs, palm_offset=0.0675):
    """
...
if __name__ == "__main__":
    ...
    # 转换为夹爪palm的6D位姿
    poses = pairs_to_grasp_poses(pairs, palm_offset=0.0675)  # 使用正值！
