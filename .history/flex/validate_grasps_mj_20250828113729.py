...
def main():
    ...
    ap.add_argument('--xml', required=True, help='XML 含夹爪、lego freejoint、grasp腱执行器')
    ap.add_argument('--grasps', required=True, help='抓取JSON，字段包含 position, quaternion_xyzw在物体坐标系')
    ap.add_argument('--index', type=int, default=0, help='使用第几个抓取默认0')
    ...
    ap.add_argument('--close', type=float, default=0.02, help='夹爪合拢命')
    ...
    ap.add_argument('--egl', action='store_true', help='使用 EGL')
